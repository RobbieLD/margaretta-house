...
import MultiImageHero from '@/components/MultiImageHero.vue';
</script>
...
<template>
    <div>
        ...
        <BannerImageHero title="Natural Tranquility" content="Relax in the peaceful natural surroundings and reconnect with nature" image="nature.jpg" justify="end" align="center"></BannerImageHero>
        <MultiImageHero title="Relax and Recharge" :images="['/mirror.jpg','/pool.jpg', '/clock.jpg', '/window.jpg']" content="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam tempus lobortis scelerisque. Vivamus dictum elit quis quam laoreet feugiat. Quisque porttitor ipsum in erat bibendum pellentesque. Integer luctus interdum augue ut feugiat. Proin non nunc euismod, facilisis nisi sed, vulputate metus. Mauris vitae dapibus velit, vel pulvinar nisi. Mauris vitae mauris quis arcu eleifend iaculis non sit amet lacus. Morbi odio lectus, pretium sed ligula vitae, tempor placerat mauris. Maecenas tempus vitae urna sit amet hendrerit. "></MultiImageHero>
    </div>
</template>
